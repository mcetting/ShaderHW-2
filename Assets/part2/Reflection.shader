Shader "Custom/Reflection" {
    Properties {
      ...
      _Cube ("Cubemap", CUBE) = "" {}
      _ReflectRefract("Ref/Ref Factor", Range(0, 1)) = 0
      _red("red", Range(0, 1)) = .1
      _blue("blue", Range(0, 1)) = .7
      _green("green", Range(0, 1)) = .4
    }
     SubShader
    {
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
             ...
             float3 vRefractRed = refract( vIncident, i.normalInWorldCoords, _red );
             float3 vRefractGreen = refract( vIncident, i.normalInWorldCoords, _green );
             float3 vRefractBlue = refract( vIncident, i.normalInWorldCoords, _blue);
             ...
             return float4(lerp(reflectColor, refractColor, _ReflectRefract).rgb, 1.0);
